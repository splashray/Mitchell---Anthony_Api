...
const createApplication = handleAsync(async (req, res, next) => {
...
const getUserApplication = handleAsync(async (req, res, next) => {
...
const getAllApplication = handleAsync(async (req, res, next) => {
...
const deleteApplication = handleAsync(async (req, res, next) => {
...
const updateApplication = handleAsync(async (req, res, next) => {
...
const updateApplicationStatus = handleAsync(async (req, res, next) => {
